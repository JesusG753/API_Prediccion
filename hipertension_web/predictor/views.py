...
def send_report(request):
    if request.method == 'POST':
        try:
            ...
            sexo_map = {0: 'Femenino', 1: 'Masculino'}
            actividad_map = {
                1: 'Muy Baja',
                2: 'Baja',
                3: 'Moderada',
            ...
            story.append(Paragraph("Reporte de Predicción de Riesgo de Hipertensión", styles['Title']))
            ...
            prediction_text = "El paciente presenta riesgo de Hipertensión" if prediction_data.get('prediction') == "Con riesgo" else "El paciente no presenta riesgo de Hipertensión"
            ...
            email_message = EmailMessage(
                subject='Reporte de Predicción de Riesgo de Hipertensión',
                body=f'Hola {nombre_completo},\n\nAdjunto encontrarás el reporte de predicción de riesgo de hipertensión.\n\nSaludos,\nEquipo de Predicción',
